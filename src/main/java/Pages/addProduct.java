...
// PRODUCT INFO
       ...
       public void imagebyUpload() throws AWTException, InterruptedException {
           ...
           String filePath = System.getProperty("user.dir") + "C:\\Downloads\\feedback_1572605207490.jpg";

//           StringSelection image = new StringSelection("C:\\Downloads\\feedback_1572605207490.jpg");
//           Toolkit.getDefaultToolkit().getSystemClipboard().setContents(image,null);
//           System.out.println("selection" +image);
    ...
    private void uploadFilewithRobot(String filePath) throws AWTException {
            ...
            Toolkit.getDefaultToolkit().getSystemClipboard().setContents(image,null);
            System.out.println("selection" +image);
//        StringSelection image;
//        image = new StringSelection(image);
